...
<body class="antialiased bg-slate-50 text-slate-900 font-[figtree]">
    ...
    <div style="background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('{{ asset('assets/bg.webp') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;" class="relative pt-32 overflow-hidden min-h-screen flex items-center justify-center">
